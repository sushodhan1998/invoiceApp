...
public class InvoiceController {
    ...
    @PostMapping()
    public ResponseEntity<InvoiceIdResponse> createInvoice(@RequestBody Invoice invoicePayload){
    ...
    public ResponseEntity<Set<Invoice>> processOverDue(@RequestBody InvoiceOverDue invoiceOverDue){
